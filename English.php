...
class English implements Language
{
    ...
    public function oldtranslations(): array
    {
        return array(
            ...
            'forms.party.notvoter' => '§cSorry, you need the §l§3VOTER§r§c rank to use this function!',
            ...
            'vote.successful' => '§aSuccessfully claimed your rank. Thanks for voting for §eNether§6Games§a!',
            'win' => 'Win',
