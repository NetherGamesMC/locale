...
class Portuguese implements Language
{
    public function translations(): array
    {
        return [
            ...
            'command.chat.usage.nothing' => '§cDesculpe, não podes trocar de chats se não estiveres numa party.',
            'command.chat.usage.party' => '§cViva! Execute /c party para ativares o chat da party, execute /c off para desativares o chat da party.',
            'database.error' => '§l§cUm erro inesperado ocorreu durante a conexão com à base de dados. Os teus dados não serão salvos nesta sessão.',
